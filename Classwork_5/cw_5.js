...
// let smallest = (number1, number2, number3) => {
...
//
// let biggest = (number1, number2, number3) => {
//     if (number1 > number2 && number1 > number3) {
//         document.write(`<div>${number1}</div>`)
//     } else if (number2 > number1 && number2 > number3) {
//         document.write(`<div>${number2}</div>`)
...
// let arr = [5, 6, 8, 20, 2, 15]
// let biggest = (array) => Math.max(...array)
// console.log(biggest(arr))

// - створити функцію яка повертає найменьше число з масиву

// let arr = [5, 6, 8, 20, 2, 15]
// let biggest = (array) => Math.min(...array)
// console.log(biggest(arr))
